...
## Project Structure
    ...
    ├── cameron_test_app_de_23787  # Django project configurations
...
1. Clone this repo and `cd cameron_test_app_de_23787`
...
2. Clone this repo and `cd cameron_test_app_de_23787`
